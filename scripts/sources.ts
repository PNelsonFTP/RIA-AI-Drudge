...
export const SOURCES: FeedSource[] = [
  ...
  { name: "Kitces — Advisor FinTech", url: "https://feeds.feedburner.com/KitcesNerdsEyeView", category: "advisor_tech", priority: "critical" },
  ...
  { name: "Wealth Solutions Report", url: "https://www.wealthsolutionsreport.com/rss/", category: "wealthtech", priority: "medium" },
  { name: "Robert Huebscher", url: "https://roberthuebscher.substack.com/feed", category: "practice", priority: "medium" },
  ...
  { name: "Ncontracts Nsight (vendor)", url: "https://www.ncontracts.com/nsight-blog/rss.xml", category: "compliance", priority: "medium", requireAny: AI_FILTER },

  // ── Regulators (tier 4) — primary sources ─────────────────────────────
  { name: "SEC Press", url: "https://www.sec.gov/news/pressreleases.rss", category: "regulation", priority: "critical", requireAny: AI_FILTER },
  { name: "SEC Speeches", url: "https://www.sec.gov/news/speeches-statements.rss", category: "regulation", priority: "critical", requireAny: AI_FILTER },
  { name: "NASAA", url: "https://www.nasaa.org/feed/", category: "regulation", priority: "high", requireAny: AI_FILTER },
  ...
  { name: "White House News", url: "https://www.whitehouse.gov/news/feed/", category: "regulation", priority: "high", requireAny: AI_FILTER },
  ...
  { name: "eMoney Advisor (vendor)", url: "https://emoneyadvisor.com/feed/", category: "vendors", priority: "low", requireAny: AI_FILTER },
  ...
  { name: "Reuters AI (GN)", url: "https://news.google.com/rss/search?q=site:reuters.com+(AI+OR+%22artificial+intelligence%22)+(wealth+OR+advisor+OR+bank+OR+SEC+OR+FINRA)&hl=en-US&gl=US&ceid=US:en", category: "industry", priority: "high" },
  { name: "Axios AI (GN)", url: "https://news.google.com/rss/search?q=site:axios.com+(AI+OR+%22artificial+intelligence%22)&hl=en-US&gl=US&ceid=US:en", category: "industry", priority: "medium" },
  ...
  { name: "Ben's Bites", url: "https://www.bensbites.com/feed", category: "industry", priority: "medium" },
  { name: "Stratechery", url: "https://stratechery.com/feed/", category: "industry", priority: "medium" },
  { name: "Exponential View", url: "https://www.exponentialview.co/feed", category: "industry", priority: "medium" },
  { name: "Import AI", url: "https://importai.substack.com/feed", category: "labs", priority: "medium" },
  { name: "TLDR AI", url: "https://tldr.tech/api/rss/ai", category: "industry", priority: "medium" },
  ...
  { name: "NVIDIA Newsroom", url: "https://nvidianews.nvidia.com/releases.xml", category: "labs", priority: "medium" },
  ...
  { name: "FT Artificial Intelligence", url: "https://www.ft.com/artificial-intelligence?format=rss", category: "markets", priority: "high" },
  ...
  // ── Vendor / PR (tier 9) ──────────────────────────────────────────────
  { name: "Envestnet (vendor)", url: "https://www.envestnet.com/rss.xml", category: "vendors", priority: "medium", requireAny: AI_FILTER },
  { name: "Docupace (vendor)", url: "https://www.docupace.com/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "Orion (vendor)", url: "https://www.orion.com/rss.xml", category: "vendors", priority: "medium", requireAny: AI_FILTER },
  { name: "Advisor360 (vendor)", url: "https://www.advisor360.com/blog/rss.xml", category: "vendors", priority: "low" },
  { name: "Altruist (vendor)", url: "https://www.altruist.com/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "Wealthbox (vendor)", url: "https://www.wealthbox.com/blog/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "TIFIN (vendor)", url: "https://www.tifin.com/feed", category: "vendors", priority: "low" },
  { name: "Vanilla (vendor)", url: "https://www.justvanilla.com/blog/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "Wealth.com (vendor)", url: "https://www.wealth.com/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "Nitrogen (vendor)", url: "https://www.nitrogenwealth.com/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "Practifi (vendor)", url: "https://www.practifi.com/blog/feed", category: "vendors", priority: "low", requireAny: AI_FILTER },
  { name: "SS&C (vendor)", url: "https://www.ssctech.com/blog/rss.xml", category: "vendors", priority: "low", requireAny: AI_FILTER },
  ...
  { name: "Business Wire wealth AI", url: "https://news.google.com/rss/search?q=site:businesswire.com+(%22wealth+management%22+OR+RIA+OR+advisor)+AI&hl=en-US&gl=US&ceid=US:en", category: "vendors", priority: "low" },
];
...
export const KEYWORDS: { match: string[]; routeTo: CategoryId }[] = [
  ...
  { match: ["compliance", "supervision", "books and records", "surveillance", "archiving", "regbi", "reg bi", "fiduciary", "smarsh", "hadrius"], routeTo: "compliance" },
  ...
  { match: ["ai etf", "ai stock", "ai trade", "capex", "nvidia", "hyperscaler", "datacenter", "data center"], routeTo: "markets" },
  { match: ["gpt-", "claude ", "gemini ", "openai", "anthropic", "deepmind", "foundation model"], routeTo: "labs" },
